//------------------------------------------------------------------------------
// This is the source code of the remove-cstr-calls tool, taken directly from
// the Clang repository (tools/extra/remove-cstr-calls). This is for
// experimentation purpose with refactoring/replacement-based tools.
//
// What's different? Well, keeping track of changes is no fun - there's git and
// diff for that ;-)
//
